...
//@TODO - 3 RCC Setting
    ...
    // GPIOA->CRH |= GPIO_CRH_MODE8 | GPIO_CRH_CNF8 | GPIO_CRH_MODE9 | GPIO_CRH_CNF9 | GPIO_CRH_MODE10 | GPIO_CRH_CNF10_1;
...
//@TODO - 4 GPIO Configuration
    ...
    /* Reset(Clear) Port D CRH - User S1 Button */ // 11번
    GPIOD->CRH &= ~(GPIO_CRH_CNF11 | GPIO_CRH_MODE11);
    /* User S1 Button Configuration */
    GPIOD->CRH |= /*GPIO_CRH_MODE11 | */ GPIO_CRH_CNF11_1;
}
